...
if (empty($_FILES) === false) {
 ...
 $water_pos = 5;//水印位置，10种状态【0为随机，1为顶端居左，2为顶端居中，3为顶端居右；4为中部居左，5为中部居中，6为中部居右；7为底端居左，8为底端居中，9为底端居】
 $water_img = $_SERVER['DOCUMENT_ROOT'].'/upfiles/logo2.gif';//水印图片,默认填写空,请将图片上传至网站根目录的upfiles下,例: water.gif
 $water_alpha = 50;//水印透明度
 //$water_text = 'Sileo源专用预览截图';//水印字符串,默认填写空;
 //$water_fontfile = $_SERVER['DOCUMENT_ROOT'] .'/upfiles/fonts/arial.ttf';//文字水印使用的字体;
 if($water_mark == 1){
   imageWaterMark($file_path, $water_pos, $water_img, $water_alpha);
 }
